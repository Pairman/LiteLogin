...
public class VelocityInjector {
    public void inject(Core coreApi) throws NoSuchFieldException, ClassNotFoundException, NoSuchMethodException, IllegalAccessException, InvocationTargetException, ReflectiveOperationException {
