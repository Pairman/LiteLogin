...
public class SkinRestorerCore {
    ...
    static {
        try {
            ...
            throw new RuntimeException("An exception occurred while generating the Yggdrasil session public key.", e);
        }
    }

    private final Core core;

    public SkinRestorerCore(Core core) {
        this.core = core;
    }
    ...
    public SkinRestorerResultImpl doRestorer(AuthResult result0) {
        ...
        SkinRestorerTask skinRestorerTask = new SkinRestorerTask(
                core,
                serviceConfig.getSkinRestorer().getTimeout(),
                serviceConfig.getSkinRestorer().getRetry(),
